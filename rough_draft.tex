...
\definecolor{greeno}{RGB}{20, 127, 20}  % A nice, bright blue
\hypersetup{
    colorlinks=true,   % false: boxed links; true: colored links
    linkcolor=blue,    % color of internal links
    citecolor=greeno,   % color of links to bibliography
    urlcolor=magenta   % color of external links
}
% Define a basic style for Lean
...
\textbf{WRITE A SUMMARY HERE ONCE THE WORK IS DONE}
